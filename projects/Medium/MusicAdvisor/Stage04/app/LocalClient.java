package projects.Medium.MusicAdvisor.Stage04.app;
...
public class LocalClient {
    ...
    private URI uri;
    private String code; // getting from redirected server
    private String access; // getting from main application to build uri
